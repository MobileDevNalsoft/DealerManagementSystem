                            ...
                            listener: (context, state) {
                              switch (state.serviceUploadStatus) {
                                case ServiceUploadStatus.success:
                                  ...
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const InspectionIn()));
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => const AddVehicle()));
                          },
                          child: Column(
                            children: [
                              Image.asset(
