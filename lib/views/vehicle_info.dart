              ...
              return VehicleInfoClippedButton(
                ...
                child: Transform.flip(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: constraints.maxHeight * 0.08, right: constraints.maxWidth * (isMobile ? 0.07 : 0.12), bottom: isMobile ? 0 : 8),
                        child:  Row(
            ...
            builder: (context,constraints) {
              return VehicleInfoClippedButton(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(top: constraints.maxHeight * 0.08, left: constraints.maxWidth * (isMobile ? 0.07 : 0.12), bottom: isMobile ? 0 : 8),
