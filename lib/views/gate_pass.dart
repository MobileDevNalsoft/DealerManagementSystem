                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ClipShadowPath(
                          ...
                          shadow: Shadow(color: Colors.black, blurRadius: 2.5),
                          child: Container(
                            alignment: Alignment.center,
...
class RoundedEdgeClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(0, h - 30);
    path.arcToPoint(Offset(30, h), radius: Radius.circular(-30), clockwise: false);
    path.lineTo(40, h);
    ...
    if (edge == Edge.bottom || edge == Edge.vertical || edge == Edge.all) {
      ...
      path.lineTo(w - 30, y);
      path.arcToPoint(Offset(w, h - 30), radius: Radius.circular(30), clockwise: false);
    }
    ...
    // Top or Vertical
    path.lineTo(w, 30);
    path.arcToPoint(Offset(w - 30, 0), radius: Radius.circular(30), clockwise: false);
    ...
    path.arcToPoint(Offset(0, 30), radius: Radius.circular(30), clockwise: false);
