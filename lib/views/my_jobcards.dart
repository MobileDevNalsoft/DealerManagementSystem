  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Container(
              margin: EdgeInsets.only(left: size.width * 0.045, top: isMobile ? 0 : size.height * 0.008, bottom: isMobile ? 0 : size.height * 0.008),          decoration: BoxDecoration(
      ...
      body: Container(
        ...
        child: BlocBuilder<ServiceBloc, ServiceState>(
          builder: (context, state) {
            return SizedBox(
              height:isMobile?null:state.myJobCards!.length<=8?size.height*0:null,
              child: GridView.builder(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: isMobile?1:state.myJobCards!.length<=1?1:2),
                itemCount:
                        ...
                        child: Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                height: size.height * 0.05,
                                width: size.width * (isMobile? 0.94:0.4),
                                decoration: BoxDecoration(
                                    color: Colors.orange.shade200,
