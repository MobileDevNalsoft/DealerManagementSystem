...
import 'package:dms/models/hotspots.dart';
...
class _Madhan3DState extends State<Madhan3D> with ConnectivityMixin{
  ...
  DoublyLinkedHotspots linkedHotspots = DoublyLinkedHotspots();
                                            ...
                                            IconButton(
                                              onPressed: () {
                                                ...
                                                if(state.mapMedia.length > 1){
                                                  ...
                                                  _autoScrollController.jumpTo(index-1);
                                                  _changeButtonColors(hotSpots.elementAt(index-1).key);
                                                  _multiBloc.add(ModifyVehicleInteractionStatus(selectedBodyPart: hotSpots.elementAt(index-1).key, isTapped: true));
                                                }
                                              },
                                              icon: const Icon(
                                                Icons.cancel,
                                          ...
                                          onTap: () {
                                            ...
                                            if (state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.comments!.trim().isEmpty) {
                                              ...
                                              _interactionBloc.add(SubmitBodyPartVehicleMediaEvent(
                                                  bodyPartName: state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.name, jobCardNo: _serviceBloc.state.jobCardNo!
