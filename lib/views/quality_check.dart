...
class _QualityCheckState extends State<QualityCheck> with SingleTickerProviderStateMixin, ConnectivityMixin {
  ...
  void initState() {
    ...
    _interactionBloc.add(FetchVehicleMediaEvent(jobCardNo: _serviceBloc.state.service!.jobCardNo ?? widget.jobCardNo));
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                            gradient: LinearGradient(
                                ...
                                stops: [0.1, 0.5, 1])),
                        child: Image.asset('assets/images/car_skeleton.png'),
                      ),
                                                          ...
                                                          children: [
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                    ...
                                                                    style: TextStyle(
                                                                        ...
                                                                        fontSize: ParentSize.maxWidth * 0.040)),
                                                              ],
                                                            ),
                                                            const Gap(8.0),
                                                            SizedBox(
                                                            ...
                                                            if (context
                                                              ...
                                                              BlocConsumer<VehiclePartsInteractionBloc, VehiclePartsInteractionBlocState>(
                                                                ...
                                                                builder: (context, state) {
                                                                  if (state.mapMedia[context.read<MultiBloc>().state.selectedGeneralBodyPart]!.isAccepted ==
                                                                      false) {
                                                            ...
                                                            if (_interactionBloc.state.mapMedia[context.read<MultiBloc>().state.selectedGeneralBodyPart] !=
                                                                null)
                                                              const SizedBox(
                                                                height: 40,
                                                              )
                                                          ...
                                                          Text(
                                                              context
                                                                  ...
                                                                  : context
                                                                      ...
                                                                      .comments!,
                                                              style:
                                                                  TextStyle(color: const Color.fromARGB(255, 223, 220, 220), fontSize: size.maxWidth * 0.040)),
                                                        ],
                                                      ),
                                                      const Gap(8.0),
                                                      SizedBox(
                      ...
                      listener: (context, state) {
                        switch (state.status) {
                          case VehiclePartsInteractionStatus.success:
                            _serviceBloc.add(GetInspectionDetails(jobCardNo: widget.jobCardNo));
