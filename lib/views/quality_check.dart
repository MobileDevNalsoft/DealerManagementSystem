...
class QualityCheck extends StatefulWidget {
  ...
  QualityCheck({super.key, required this.model, this.generalParts, this.acceptedParts, this.rejectedParts, this.pendingParts, this.jobCardNo = "JC-LOC-12"});
  @override
...
class _QualityCheckState extends State<QualityCheck> with SingleTickerProviderStateMixin, ConnectivityMixin {
  ...
  void initState() {
    ...
    context.read<VehiclePartsInteractionBloc>().add(FetchVehicleMediaEvent(jobCardNo: context.read<ServiceBloc>().state.jobCardNo!));
                      ...
                      child: 
                       GestureDetector(
                        onTap: () {
                            ...
                            context.read<VehiclePartsInteractionBloc>().add(SubmitQualityCheckStatusEvent(jobCardNo: widget.jobCardNo));
                          },
                         child: Container(
                                                  alignment: Alignment.center,
                  ...
                  Center(
                    child: DraggableScrollableSheet(
                      ...
                      !context
                        ...
                        .state
                        .mapMedia
                        .containsKey(Provider.of<BodySelectorViewModel>(context, listen: true).selectedGeneralBodyPart)?0.25:
                       context
                      ...
                      initialChildSize: !context
                        ...
                        .state
                        .mapMedia
                        .containsKey(Provider.of<BodySelectorViewModel>(context, listen: true).selectedGeneralBodyPart)?0.25: context
                                      .watch<VehiclePartsInteractionBloc>()
                                      .state
                                      .mapMedia[Provider.of<BodySelectorViewModel>(context, listen: false).selectedGeneralBodyPart]!
                                      .isAccepted ==
                      ...
                      builder: (BuildContext context, ScrollController scrollController) {
                        ...
                        .state
                        .mapMedia
                        .containsKey(Provider.of<BodySelectorViewModel>(context, listen: true).selectedGeneralBodyPart)? SliverToBoxAdapter(child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text("No data found",textAlign: TextAlign.center,style: TextStyle(color: Colors.white54),),
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Gap(8),
                                              Text(
                                                Provider.of<BodySelectorViewModel>(context, listen: true)
                                                ...
                                                if (state.mapMedia[Provider.of<BodySelectorViewModel>(context, listen: false).selectedGeneralBodyPart]!
                                                  ...
                                                  return TextFormField(
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      scrollController.animateTo(150, duration: Duration(milliseconds: 500), curve: Curves.decelerate);
                                                    },
