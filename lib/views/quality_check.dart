                                                                ...
                                                                return Stack(
                                                                  children: [
                                                                    PhotoViewGallery
                                                                      ...
                                                                      pageSnapping:
                                                                          true,
                                                                      itemCount: context.watch<VehiclePartsInteractionBloc>().state.mapMedia[Provider.of<BodySelectorViewModel>(context, listen: true).selectedGeneralBodyPart]!.images ==
                                                                              null
                                                                          ? 0
                                                                          : context
                                                                              .watch<VehiclePartsInteractionBloc>()
                                                                      ...
                                                                      builder: (BuildContext
                                                                        ...
                                                                        return PhotoViewGalleryPageOptions(
                                                                          ...
                                                                          heroAttributes:
                                                                              PhotoViewHeroAttributes(tag: context.watch<VehiclePartsInteractionBloc>().state.mapMedia[Provider.of<BodySelectorViewModel>(context, listen: true).selectedGeneralBodyPart]!.images![index].path),
                                                                        );
                                                                      },
                                                                    ),
                                                                    Positioned(
