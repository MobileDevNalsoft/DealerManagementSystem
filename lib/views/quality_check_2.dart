                                                ...
                                                child: InkWell(
                                                  ...
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                                        ...
                                                        color: context.watch<VehiclePartsInteractionBloc2>().state.vehicleExaminationPageIndex == index
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: ListView(
                                        ...
                                        children: state.mapMedia.entries.map((e) {
                                          ...
                                          if (sliderButtonControllers.isNotEmpty) {
                                              ...
                                              : GestureDetector(
                                                  ...
                                                  child: Container(
                                                      padding: isMobile
                                                          ...
                                                          : EdgeInsets.symmetric(horizontal: size.width * 0.05, vertical: size.width * 0.032),
                                                            ...
                                                            slivers: [
                                                              SliverToBoxAdapter(
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                      child: Text(
                                                                          context.watch<VehiclePartsInteractionBloc2>().state.mapMedia[
                                                              ...
                                                              SliverGrid.builder(
                                                                  ...
                                                                  itemCount: context
                                                                              ...
                                                                              .state
                                                                              .mapMedia[context.watch<VehiclePartsInteractionBloc2>().state.selectedBodyPart]!
                                                                              .images ==
                                                                          null
                                                                      ? 0
