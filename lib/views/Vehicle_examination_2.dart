                                    ...
                                    child: Center(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                                                  ...
                                                                  child: SizedBox(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        context.watch<MultiBloc>().state.renamingStatus == HotspotRenamingStatus.initial
                                                                            ...
                                                                            : Expanded(
                                                                                child: TextFormField(
                                                                                  ...
                                                                                  controller: TextEditingController(text: hotSpots.elementAt(hotspotIndex).key),
                                                                                  showCursor: true,
                                                                                  autofocus: true,
                                                                        ...
                                                                        Spacer(),
                                                                        if (context.watch<MultiBloc>().state.renamingStatus == HotspotRenamingStatus.initial)
                                                                          Align(
                                                                            alignment: Alignment.centerRight,
                                                                            child: IconButton(
                                                                                onPressed: () {
                                                                                  _multiBloc.add(
                                                                                      ModifyRenamingStatus(renameStatus: HotspotRenamingStatus.openTextField));
                                                                                },
                                                                  ...
                                                                  Expanded(
                                                                    child: TextButton(
                                                                      ...
                                                                      style: TextButton.styleFrom(
                                                                          fixedSize: Size(size.width * 0.3, size.height * 0.1), foregroundColor: Colors.white),
                                                                      child: Text(
                                                                        'Delete',
                                          ...
                                          icon: Icon(hotSpots.elementAt(hotspotIndex).value.isUploaded == false ? Icons.settings_rounded : Icons.done_rounded),
                                          padding: EdgeInsets.zero,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        Skeletonizer(
                                          enabled:
                                              context.watch<MultiBloc>().state.selectedGeneralBodyPart.isEmpty || !context.watch<MultiBloc>().state.isTapped,
                                          child: TextFormField(
                                            // key: _formKey,
                                            // focusNode: commentsFocus,
                                            controller:
                                                TextEditingController(text: state.mapMedia[context.read<MultiBloc>().state.selectedGeneralBodyPart]!.comments),
                                            ...
                                            onChanged: (value) {
                                              _interactionBloc
                                                  .add(AddCommentsEvent(name: state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.name, comments: value));
                                            },
                                          ),
                                        ),
                                        Align(
                                          ...
                                          child: IconButton(
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.images!.length < 3) {
                                                  ...
                                                  if (image != null) {
                                                    _interactionBloc
                                                        .add(AddImageEvent(name: state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.name, image: image));
                                                  }
                                                }
                                              },
                                              icon: Stack(
                                  ...
                                  Container(
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemCount: hotSpots.elementAt(pageIndex).value.images == null ? 0 : hotSpots.elementAt(pageIndex).value.images!.length,
                                      )),
                            ...
                            children: [
                              ...
                              IntrinsicWidth(
                                child: InkWell(
                                  onTap: () async {
                                    int elementIndex = 0;
                                    for (var e in _interactionBloc.state.mapMedia.entries.toList()) {
                                      if (e.value.isUploaded == false) {
                                        DMSCustomWidgets.DMSFlushbar(size, context,
                                            message: "Please upload ${e.key} data",
                                            icon: Icon(
                                              Icons.error_rounded,
                                              color: Colors.white,
                                            ));
