                               ...
                               IntrinsicWidth(
                                 child: InkWell(onTap: () async{
                                  ...
                                  if(hotspotsData.isEmpty){
                                     DMSCustomWidgets.DMSFlushbar(size, context,message: "Please add atleast one hotspot",icon: Icon(Icons.error_rounded,color: Colors.white,));
                                     return;
                                  }
                                  int elementIndex=0;
                                  for (var e in hotspotsData) {if(e.value.isUploaded==false){
