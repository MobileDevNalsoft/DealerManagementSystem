...
class _VehicleExamination2State extends State<VehicleExamination2> with ConnectivityMixin {
  ...
  void _changeButtonColors(String name) async {
    await webViewController.runJavaScript('changeHotSpotColors("$name")');
  }
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              if (context.watch<VehiclePartsInteractionBloc2>().state.mapMedia.isNotEmpty)
                Positioned(
                    bottom: 0,
                    child: Container(
                            ...
                            children: [
                                      ...
                                      return AutoScrollTag(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            ...
                                            _pageController.jumpToPage(index);
                                            _changeButtonColors(hotSpots.elementAt(index).key);
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                              ...
                                              children: [
                                                ...
                                                IconButton(
                                                  onPressed: () {
                                                    _removeButton(hotSpots.elementAt(index).key);

                                                    _interactionBloc.add(RemoveHotspotEvent(name: hotSpots.elementAt(index).key));
                                                    if (state.mapMedia.length > 1) {
                                                      _pageController.jumpToPage(state.mapMedia.length - 1);
                                                      _autoScrollController.jumpTo(state.mapMedia.length - 1);
                                                      _changeButtonColors(hotSpots.elementAt(state.mapMedia.length - 1).key);
                                                      _multiBloc.add(ModifyVehicleInteractionStatus(
                                                          selectedBodyPart: hotSpots.elementAt(state.mapMedia.length - 1).key, isTapped: true));
                                                      _interactionBloc.add(ModifyVehicleExaminationPageIndex(index: state.mapMedia.length - 2));
                                                      print(state.vehicleExaminationPageIndex);
                                                    }
                                                  },
                                                  icon: const Icon(
                                                    Icons.cancel,
                              ...
                              Expanded(
                                child: PageView.builder(
                                  ...
                                  onPageChanged: (value) {
                                    _multiBloc.add(
                                        ModifyVehicleInteractionStatus(selectedBodyPart: hotSpots.elementAt(value).key, isTapped: _multiBloc.state.isTapped));
                                              ...
                                              children: [
                                                TextFormField(
                                                  ...
                                                  controller: TextEditingController(
                                                      text: state.mapMedia[context.watch<MultiBloc>().state.selectedGeneralBodyPart]!.comments),
                                                  ...
                                                  onChanged: (value) {
                                                    _interactionBloc.add(AddCommentsEvent(
                                                        name: state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.name, comments: value));
                                                  },
                                                ),
                                                Align(
                                                  ...
                                                  child: IconButton(
                                                      ...
                                                      onPressed: () async {
                                                        ...
                                                        if (state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.images!.length < 3) {
                                                          ...
                                                          if (image != null) {
                                                            _interactionBloc.add(AddImageEvent(
                                                                name: state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.name, image: image));
                                                          }
                                                        }
                                                      },
                                                      icon: Stack(
                                            ...
                                            InkWell(
                                              ...
                                              onTap: () {
                                                ...
                                                if (state.mapMedia[_multiBloc.state.selectedGeneralBodyPart]!.comments!.trim().isEmpty) {
                                                  ...
                                                  print(_serviceBloc.state.jobCardNo);
                                                  _interactionBloc.add(SubmitBodyPartVehicleMediaEvent(
                                                      ...
                                                      jobCardNo: _serviceBloc.state.jobCardNo!
