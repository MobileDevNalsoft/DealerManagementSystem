    ...
    return PopScope(
      ...
      child: Scaffold(
          ...
          appBar: DMSCustomWidgets.appBar(
              size: size, isMobile: isMobile, title: 'Job Card Details'),
          body: Stack(
            children: [
              Container(
                height: size.height,
                    ...
                    IntrinsicHeight(
                      child: Container(
                        margin: EdgeInsets.only(
                            ...
                            left: size.width * (isMobile ? 0.02 : 0.08),
                            right: size.width * (isMobile ? 0.02 : 0.08)),
                        ...
                        decoration: BoxDecoration(
                            color: Colors.white,
                            borderRadius:
                                BorderRadius.circular(isMobile ? 25 : 35)),
                        child: Column(
                          children: [
                            buildDetailRow(
                                'Job Card Number',
                          ...
                          return Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.only(
                                      topLeft:
                                          Radius.circular(isMobile ? 25 : 35),
                                      topRight:
                                          Radius.circular(isMobile ? 25 : 35)),
                                  boxShadow: const [
                                    BoxShadow(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                      flex: 1, child: Gap(size.height * 0.01)),
