...
_$DynamicColumnImpl _$$DynamicColumnImplFromJson(Map<String, dynamic> json) => _$DynamicColumnImpl(
...
Map<String, dynamic> _$$DynamicColumnImplToJson(_$DynamicColumnImpl instance) => <String, dynamic>{
