...
import '../Widgets/Center/dynamic_center.dart';

class DynamicCenterParser extends JsonToWidgetParser<DynamicCenter> {
  const DynamicCenterParser();

  @override
  DynamicCenter getModel(Map<String, dynamic> json) => DynamicCenter.fromJson(json);

  @override
  String get type => WidgetType.center.name;

  @override
  Widget parse(BuildContext context, DynamicCenter model, [Map<String, dynamic>? functions]) {
    return Center(
