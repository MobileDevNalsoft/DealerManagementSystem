...
class VehiclePartsInteractionBloc extends Bloc<VehiclePartsInteractionBlocEvent,
  ...
  VehiclePartsInteractionBloc({Repository? repo, this.navigator})
    ...
    on<ModifyAcceptedEvent>(_onModifyAcceptedStatus
        as EventHandler<ModifyAcceptedEvent, VehiclePartsInteractionBlocState>);
    ...
    on<AddHotspotEvent>(_onAddHotspot
        as EventHandler<AddHotspotEvent, VehiclePartsInteractionBlocState>);
  ...
  void _onAddHotspot(
      AddHotspotEvent event, Emitter<VehiclePartsInteractionBlocState> emit) {
    state.mapMedia.putIfAbsent(
      event.name,
      () {
        return VehiclePartMedia(
            name: event.name, isUploaded: false, images: [], comments: "");
      },
    );
